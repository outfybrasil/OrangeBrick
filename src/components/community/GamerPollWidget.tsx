    ...
    <div className="bg-gradient-to-br from-brand-orange/10 via-card-slate/70 to-background-void border border-brand-orange/30 rounded-2xl p-5 shadow-xl relative overflow-hidden space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[10px] font-subtitle font-bold text-brand-orange uppercase tracking-widest bg-brand-orange/15 px-2 py-0.5 rounded border border-brand-orange/30">
            Enquete da Semana
          </span>
        </div>
        <span className="text-[11px] font-subtitle text-gray-400 font-medium">
