...
export function UserBadge({ isOfficial }: UserBadgeProps) {
  ...
  return (
    <span
      ...
      className="inline-flex shrink-0 cursor-default select-none items-center gap-1 rounded-lg border border-brand-orange/45 bg-brand-orange/10 px-1.5 py-0.5 text-xs font-black uppercase tracking-wider text-brand-orange"
    >
      ...
      <span className="text-xs text-white">Oficial</span>
    </span>
  );
}
