    ...
    <main className="grid min-h-dvh bg-background-void text-white lg:grid-cols-[minmax(0,0.9fr)_minmax(30rem,1.1fr)]">
      <section className="relative hidden min-h-dvh overflow-hidden border-r border-white/10 bg-[#15161b] p-10 lg:flex lg:flex-col lg:justify-between xl:p-16">
        ...
        <div className="max-w-xl">
          <p className="font-subtitle text-xs font-bold uppercase tracking-[0.16em] text-brand-orange">Sua comunidade gamer</p>
          <h2 className="mt-5 text-balance font-heading text-5xl font-black leading-[0.96] tracking-[-0.03em] xl:text-6xl">Continue de onde a discussão parou.</h2>
          <p className="mt-6 max-w-[58ch] text-base leading-7 text-gray-400">Seu perfil, seus votos e suas conversas ficam reunidos no Brickboard.</p>
        </div>
